...
(function () {
	var kazoo = {
		config: {
			paths: {
				AC_OETags: 'js/libs/libwebphone/dependencies/rtmp/AC_OETags.js',
				VideoIO: 'js/libs/libwebphone/dependencies/rtmp/VideoIO',
				SIPjs: 'js/libs/libwebphone/dependencies/sip/sip.js'
			},
		},
		rtmp: {},
		sipjs: {}
